...
class RequestLoggingMiddleware : HttpServer
{
    ...
    public override async Task<HttpResponse> InvokeAsync(HttpRequest request)
    {
        ...
        try
        {
            ...
            _metrics.RecordRequestDuration(new RoasteryMetrics.Sample.RequestDurationKey(request.Path, (int)response.StatusCode), requestTiming.ElapsedMilliseconds);
        ...
        catch
        {
            ...
            _metrics.RecordRequestDuration(new RoasteryMetrics.Sample.RequestDurationKey(request.Path, (int)statusCode), requestTiming.ElapsedMilliseconds);
